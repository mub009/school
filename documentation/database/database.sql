...
CREATE TABLE `employees` (
  ...
  `blood_group` varchar(15) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `events` (
  ...
  `role_id` int(11) NOT NULL,
  `title` varchar(255) CHARACTER SET utf8 NOT NULL,
  `event_place` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `exam_results` (
  ...
  `merit_rank_in_class` varchar(50) CHARACTER SET utf8 NOT NULL,
  `merit_rank_in_section` varchar(50) CHARACTER SET utf8 NOT NULL,
...
CREATE TABLE `income_heads` (
  `id` int(11) NOT NULL,
  `school_id` int(11) NOT NULL,
  `head_type` varchar(50) CHARACTER SET utf8 DEFAULT NULL COMMENT 'fee, income, hostel, transport',
  `title` varchar(255) CHARACTER SET utf8 NOT NULL,
  `note` text CHARACTER SET utf8,
  `status` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
...
CREATE TABLE `schools` (
  ...
  `logo` varchar(120) CHARACTER SET utf8 DEFAULT NULL,
  `session_start_month` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `session_end_month` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `academic_year_id` int(11) DEFAULT NULL,
  `academic_year` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `school_fax` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `school_lat` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `school_lng` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `theme_name` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `sms_settings` (
  ...
  `clickatell_from_number` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `clickatell_mo_no` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `plivo_from_number` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `plivo_status` tinyint(1) DEFAULT NULL,
  `textlocal_username` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  ...
  `smscountry_username` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `students` (
  ...
  `previous_class` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `transfer_certificate` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `health_condition` text CHARACTER SET utf8,
  `national_id` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `second_language` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
...
CREATE TABLE `suggestions` (
  ...
  `suggestion` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `status` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `modified_at` datetime NOT NULL,
  `created_by` int(11) NOT NULL,
...
CREATE TABLE `teachers` (
  ...
  `permanent_address` varchar(255) CHARACTER SET utf8 DEFAULT NULL,
  `gender` varchar(10) CHARACTER SET utf8 NOT NULL,
  `blood_group` varchar(15) CHARACTER SET utf8 NOT NULL,
  `religion` varchar(100) CHARACTER SET utf8 DEFAULT NULL,
  `dob` date NOT NULL,
  `joining_date` date NOT NULL,
  `resign_date` date DEFAULT NULL,
...
CREATE TABLE `transactions` (
  ...
  `pum_first_name` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `pum_email` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `pum_phone` varchar(20) CHARACTER SET utf8 DEFAULT NULL,
  `stripe_card_number` varchar(50) CHARACTER SET utf8 DEFAULT NULL,
  `note` text CHARACTER SET utf8,
  `status` tinyint(1) NOT NULL,
  `created_at` datetime NOT NULL,
  `modified_at` datetime NOT NULL,
...
(1, 1, 0, 'e10adc3949ba59abbe56e057f20f883e', 'MTIzNDU2', 'superadmin', NULL, 1, '2018-12-01 01:09:11', '2013-11-15 20:33:03', '2018-11-30 14:13:42', 0, 1);

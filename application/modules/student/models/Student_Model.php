...
class Student_Model extends MY_Model {
    ...
    public function get_student_list($class_id = null, $school_id = null, $academic_year_id = null){
        ...
        $this->db->select('S.*, SC.school_name, E.roll_no, U.username, U.role_id,  C.name AS class_name, SE.name AS section');
    ...
    public function get_single_student($id,  $academic_year_id){
        ...
        $this->db->select('S.*,  SC.school_name, D.amount, D.title AS discount_title, SC.school_name, G.name as guardian, E.academic_year_id, E.roll_no, E.class_id, E.section_id, U.username, U.role_id, R.name AS role,  C.name AS class_name, SE.name AS section');
        $this->db->from('enrollments AS E');
        $this->db->join('students AS S', 'S.id = E.student_id', 'left');
        $this->db->join('users AS U', 'U.id = S.user_id', 'left');

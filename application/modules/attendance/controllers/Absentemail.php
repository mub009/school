...
class Absentemail extends MY_Controller {
    ...
    * ********************************************************** */
    public function add() {
        ...
        if ($_POST) {
            ...
            if ($this->form_validation->run() === TRUE) {
                ...
                if ($insert_id) {
                    ...
                    redirect('attendance/absentemail/index/'.$data['school_id']);
                } else {
        ...
        $this->data['emails'] = $this->mail->get_email_list($condition['school_id']);
    ...
    * ********************************************************** */
    private function _send_email($data) {
        ...
        $receivers = '';
        $users = $this->mail->get_user_list( $data['school_id'], $data['role_id'], $this->input->post('receiver_id'), $this->input->post('class_id'), $school->academic_year_id);

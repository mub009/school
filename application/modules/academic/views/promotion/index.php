                        ...
                        <div class="item form-group"> 
                            ...
                            <select  class="form-control col-md-7 col-xs-12" name="current_session_id" id="current_session_id"  required="required">
                                <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
                                 <?php foreach($curr_session as $obj ){ ?>
                                    <option value="<?php echo $obj->id; ?>" <?php if(isset($current_session_id) && @$current_session_id == $obj->id){ echo 'selected="selected"';} ?>><?php echo $obj->session_year; ?></option>
                                <?php } ?>
                            </select>

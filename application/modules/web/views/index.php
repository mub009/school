        ...
        <div class="apply-now">
            <div class="row">
                ...
                <div class="col-lg-3 col-md-3 col-sm-4 col-12">
                    <a href="<?php echo site_url('admission'); ?>" class="link glbscl-link-btn hvr-bs" style="color: #007bff !important;"><?php echo $this->lang->line('apply'); ?>  <?php echo $this->lang->line('now'); ?></a>
                </div>
            </div>
        </div>
    </div>

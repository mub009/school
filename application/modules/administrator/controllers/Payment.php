...
class Payment extends MY_Controller {
    ...
    * ********************************************************** */
    public function add() {
        ...
        $this->data['payment_settings'] = $this->payment->get_payment_setting_list();
        $this->data['add'] = TRUE;
        $this->layout->title($this->lang->line('add') . ' ' . $this->lang->line('payment') . ' ' . $this->lang->line('setting') . ' | ' . SMS);
        $this->layout->view('payment/index', $this->data);
    }
    ...
    * ********************************************************** */
    private function _prepare_payment_setting_validation() {
        ...
        //$this->form_validation->set_rules('paypal_api_username', $this->lang->line('teacher'), 'trim');
        //$this->form_validation->set_rules('paypal_api_password', $this->lang->line('teacher'), 'trim');
        //$this->form_validation->set_rules('paypal_api_signature', $this->lang->line('teacher'), 'trim');
        $this->form_validation->set_rules('paypal_email', $this->lang->line('paypal') . ' ' . $this->lang->line('email'), 'trim');
        ...
        //$this->form_validation->set_rules('stripe_secret', $this->lang->line('secret') . ' ' . $this->lang->line('key'), 'trim');
        ...
        $this->form_validation->set_rules('payumoney_key', $this->lang->line('payumoney') . ' ' . $this->lang->line('key'), 'trim');
        $this->form_validation->set_rules('payumoney_salt', $this->lang->line('payumoney') . ' ' . $this->lang->line('key_salt'), 'trim');
        ...
        //$this->form_validation->set_rules('ccavenue_key', $this->lang->line('ccavenue') . ' ' . $this->lang->line('key'), 'trim');
        //$this->form_validation->set_rules('ccavenue_salt', $this->lang->line('ccavenue') . ' ' . $this->lang->line('key_salt'), 'trim');
        ...
        $this->form_validation->set_rules('paytm_merchant_key', $this->lang->line('paytm') . ' ' . $this->lang->line('merchant_key'), 'trim');
        $this->form_validation->set_rules('paytm_merchant_mid', $this->lang->line('paytm') . ' ' . $this->lang->line('merchant_mid'), 'trim');
        $this->form_validation->set_rules('paytm_merchant_website', $this->lang->line('paytm') . ' ' . $this->lang->line('website'), 'trim');
        $this->form_validation->set_rules('paytm_industry_type', $this->lang->line('paytm') . ' ' . $this->lang->line('industry_type'), 'trim');

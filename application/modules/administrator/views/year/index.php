                ...
                <div class="" data-example-id="togglable-tabs">
                    ...
                    <ul  class="nav nav-tabs bordered">
                        ...
                        <?php if(has_permission(ADD, 'administrator', 'year')){ ?>
                                <?php if(isset($edit)){ ?>
                                    <li  class="<?php if(isset($add)){ echo 'active'; }?>"><a href="<?php echo site_url('administrator/year/add'); ?>" aria-expanded="false"><i class="fa fa-plus-square-o"></i> <?php echo $this->lang->line('add'); ?> <?php echo $this->lang->line('academic_year'); ?></a> </li>                          
                                <?php }else{ ?>
                               ...
                               <?php echo form_open(site_url('administrator/year/add'), array('name' => 'add', 'id' => 'add', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="session_year"  id="add_session_year" required="required" >
                        ...
                        <div class="tab-pane fade in active" id="tab_edit_year">
                            <div class="x_content"> 
                               ...
                               <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <select  class="form-control col-md-7 col-xs-12"  name="session_year"  id="edit_session_year" required="required" >
                                            <option value="">--<?php echo $this->lang->line('select'); ?>--</option>
...
<!-- Super admin js START  -->
 <script type="text/javascript">
    ...
    $("document").ready(function() {
        ...
        // except super admin
        <?php if($this->session->userdata('role_id') != SUPER_ADMIN && !isset($edit)){ ?> 
    ...
    $('.fn_school_id').on('change', function(){
        ...
        get_session_by_school(school_id);
    });
     
    
    function get_session_by_school(school_id){
    
        
        var session = ''; 
        
       <?php if(isset($year) && !empty($year)){ ?>             
            session = '<?php echo $year->session_year; ?>';
       <?php } ?> 
       ...
       $.ajax({       
            type   : "POST",
            url    : "<?php echo site_url('administrator/year/get_session_by_school'); ?>",
            ...
            success: function(response){                                                   
               ...
               {  
                   if(session){
                       $('#edit_session_year').html(response);   
                   }else{
                       $('#add_session_year').html(response);   
                   }                  
               }
            }
        });

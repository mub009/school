        ...
        <tr>
            ...
            <td>
                <?php if($superadmin->resume){ ?>
                    <a href="<?php echo UPLOAD_PATH; ?>/employee-resume/<?php echo $superadmin->resume; ?>" class="btn btn-success btn-xs"><i class="fa fa-download"></i> <?php echo $this->lang->line('download'); ?></a>
                <?php } ?>
            </td>
        </tr>                    

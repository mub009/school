        ...
        <div class="x_panel">
            ...
            <div class="x_content">
                <div class="" data-example-id="togglable-tabs">                    
                    ...
                    <?php if($this->session->userdata('role_id') == SUPER_ADMIN){ ?>     
                        <li class="<?php if(isset($list)){ echo 'active'; }?>"><a href="#tab_about_list"   role="tab" data-toggle="tab" aria-expanded="true"><i class="fa fa-list-ol"></i> <?php echo $this->lang->line('about'); ?>  <?php echo $this->lang->line('school'); ?> <?php echo $this->lang->line('list'); ?></a> </li>
                    <?php } ?>  
                    <?php if(isset($edit)){ ?>
                            ...
                            <table id="datatable-responsive" class="table table-striped table-bordered dt-responsive nowrap" cellspacing="0" width="100%">
                                <thead>
                                    <tr>
                                        ...
                                        <?php } ?>
                                        <th><?php echo $this->lang->line('about'); ?></th>
                                        <th><?php echo $this->lang->line('about'); ?> <?php echo $this->lang->line('image'); ?></th>
                               ...
                               <?php echo form_open_multipart(site_url('frontend/about/edit/'.$school->id), array('name' => 'edit', 'id' => 'edit', 'class'=>'form-horizontal form-label-left'), ''); ?>
                                ...
                                <div class="item form-group">
                                    ...
                                    <div class="col-md-6 col-sm-6 col-xs-12">
                                        <textarea  class="form-control col-md-7 col-xs-12"  name="about_text"  id="edit_about_text" placeholder="<?php echo $this->lang->line('about'); ?> <?php echo $this->lang->line('school'); ?>"><?php echo isset($school->about_text) ?  $school->about_text : ''; ?></textarea>

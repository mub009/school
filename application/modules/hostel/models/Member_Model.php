...
class Member_Model extends MY_Model {
    ...
    function __construct() {
     ...
     public function get_hostel_member_list($is_hostel_member = 1, $school_id = null, $academic_year_id = null ) {

        $this->db->select('ST.*,SC.school_name, HM.id AS hm_id, H.name AS hostel_name, R.room_no, R.room_type, E.roll_no, C.name AS class_name, S.name AS section');
